...
**Triggers** act as the starting points for workflows, determining how and when a workflow is activated. Each trigger defines the conditions under which a workflow will be executed.
