...
Laravel can be installed as a stand-alone application (i.e. including everything you need to run Laravel Mail), or as a package inside an existing Laravel application.
...
```bash
git clone https://github.com/laravelcompany/laravel-mail.git
```
